 ...
 */
 ...
 import ProductByCat from './components/screens/ProductByCat';
 import SearchProduct from './components/screens/SearchProduct';
 import About from './components/screens/About';
 import Terms from './components/screens/Terms';
 import Privacy from './components/screens/Privacy';
 import Cod from './components/screens/Cod'
 ...
 const Tabs = () => {
   ...
   return (
     <Tab.Navigator tabBarOptions={{style: TabStyle, labelStyle: {
       fontSize: 14,
     }, activeTintColor: config.primaryColor, inactiveTintColor: config.defaultFontColor}}>
       <Tab.Screen name="Home" component={Home} options={{
           title: 'Home',
           tabBarIcon: ({ focused }) => <TabBarIcon focused={focused} name="home"  />,
         }} />
          <Tab.Screen name="Whatsapp" component={Home} options={{
           title: 'Whatsapp',
           tabBarIcon: ({ focused }) => <MaterialCommunityIcons focused={focused} name="whatsapp" size={25} />,
         }} />
   ...
   return (
     <NavigationContainer>
       <Stack.Navigator screenOptions={{
         ...
         <Stack.Screen name="ProductByCat" component={ProductByCat} />
